...
async function loadModels() {
  try { const r = await detectApi.getModels(); models.value = r.data } catch { /* */ }
}
loadModels()
  ...
  <div>
    ...
    <el-card style="margin-bottom: 16px">
      <el-row :gutter="16" align="middle">
        ...
        <el-col :span="6">
          <el-tag v-if="streaming" type="success">Detected: {{ count }} targets | {{ inferenceMs }}ms | {{ fps }} FPS</el-tag>
    ...
    <el-row :gutter="16">
      <el-col :span="16">
        <el-card header="Live Feed">
          <div style="position: relative; background: #000; min-height: 360px; text-align: center; border-radius: 4px">
            ...
            <el-empty v-if="!streaming" description="Click [Start Camera] to begin live detection"
      ...
      <el-col :span="8">
        <el-card header="Detected Targets" style="max-height: 500px; overflow-y: auto">
          ...
          <div v-for="(d, i) in detections" :key="i"
