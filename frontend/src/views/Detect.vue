      ...
      <el-row :gutter="16" align="middle">
        <el-col :span="5">
          <el-select v-model="selectedModel" placeholder="Select model" style="width: 100%">
            <el-option v-for="m in models" :key="m.name" :label="`${m.display_name} (mAP50: ${m.mAP50})`"
              :value="m.name" />
          </el-select>
        </el-col>
        <el-col :span="3">
        ...
        <el-col :span="3">
          <template v-if="hasResult">
            <el-button text type="warning" :loading="aiLoading" @click="handleAnalyze" :disabled="detections.length === 0">
              AI Analysis
            </el-button>
