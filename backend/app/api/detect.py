...
def detect_video(
    ...
    return DetectResponse(
        ...
        message=f"Video has {total_frames} frames, processing...",
    )
...
def analyze(
    ...
    return AnalyzeResponse(analysis=analysis or "AI analysis is currently unavailable. Please configure Qwen API Key.")
